...
scale - using low end embedded boards that make the Raspberry Pi look like 
...
a microphone, running simple lightweight code on the cheapest hardware available.

The specs of the system create severe limitations. We have 20K RAM, 64K 
